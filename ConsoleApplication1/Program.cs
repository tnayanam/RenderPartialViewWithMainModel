...
namespace ConsoleApplication1
{
    ...
    // Encapsulation: it is a way of hiding the implementation details of a class. We encapsulate the variables in capsules
    // based on access mnodifiers public, private, internal, protected and protected internal, getters, setters, readonly.
    public class Bank
    {
